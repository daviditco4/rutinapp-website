...
class Api {
  ...
  static async fetch(url, secure, init = {}, controller) {
    if (secure) { // && Api.token) {
      ...
      init.headers['Authorization'] = "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsImlhdCI6MTYzNDAyMTM4ODI5MCwiZXhwIjoxNjM0MDIzOTgwMjkwfQ.WflAMyfWUJJ7EVz322VRHJPTCSIfUsWg53l_enFYKvs" // ${Api.token}
    }
