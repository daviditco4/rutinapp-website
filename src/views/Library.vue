...
export default {
  ...
  methods: {
    ...
    retrieve() {
      if (this.showRoutines) {
        this.$getAllRoutinesCreatedByCurrentUser({
          page: this.page - 1,
          size: this.itemsPerPage,
        });
      } else {
        this.$getAllExercisesCreatedByCurrentUser({
          page: this.page - 1,
          size: this.itemsPerPage,
        });
      }
    ...
    selectRoutineFilter() {
      if (!this.showRoutines) {
        ...
        this.page = 1;
        if (this.$routinesPage) this.page = this.$routinesPage;
    ...
    selectExerciseFilter() {
      if (this.showRoutines) {
        ...
        this.page = 1;
        if (this.$exercisesPage) this.page = this.$exercisesPage;
